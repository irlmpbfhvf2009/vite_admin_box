<template>
  <Layer :layer="layer" @confirm="submit" ref="layerDom">
    <el-form :model="form" :rules="rules" ref="ruleForm" label-width="120px" style="margin-right:30px;">
      <el-form-item label="群组名称：" prop="groupTitle">
        {{ form.groupTitle }}
      </el-form-item>
      <el-form-item label="间隔秒数：" prop="advertiseTime">
        <el-input v-model="form.advertiseTime" oninput="value=value.replace(/[^\d]/g,'')" placeholder="只能输入正整数"></el-input>
      </el-form-item>
      <el-form-item label="广告内容：" prop="advertiseContent">
        <el-input type="textarea" :rows="25" v-model="form.advertiseContent"></el-input>
      </el-form-item>
...
import { updateAdvertiseData } from '@/api/app'
